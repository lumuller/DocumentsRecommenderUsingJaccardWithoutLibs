...
public interface IntersectionRepository extends MongoRepository<Intersection, String>{
	...
	List<Intersection> findByIdDocumentA(String idDocumentA);
	
	List<Intersection> findByIdDocumentB(String idDocumentB);	
